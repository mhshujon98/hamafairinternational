...
export default function PassengerDetails({ passenger, onClose }: PassengerDetailsProps) {
  ...
  const handleCopyText = () => {
    const text = `✈️ *Hama Fair International Travel Agency* ✈️
━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div id="printable-passenger-slip" className="hidden">
            <div className="header">
              <div className="title">HAMA FAIR INTERNATIONAL TRAVEL AGENCY</div>
            ...
            <div className="footer">
              Thank you for choosing Hama Fair International. Have a safe flight! <br />
